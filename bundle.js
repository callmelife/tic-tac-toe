...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGame = __webpack_require__(8);
	// const getStats = require('./game/events.js');
	// const getGameSuccess = require('./game/ui.js');

	window.app = __webpack_require__(5);
	var ticTacArray = [["box", "box", "box"], ["box", "box", "box"], ["box", "box", "box"]];
	var turnCounter = 1;
	...
	var turnOnClicks = function turnOnClicks() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGameById = function onGetGameById(event) {
	  event.preventDefault();
	  api.getGameById().done(ui.onGetGameByIdSuccess).fail(ui.fail);
	  // console.log(data);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(5);
	var gameInfo = __webpack_require__(1);
	...
	var updateGame = function updateGame(index, value, trueOrFalse) {
